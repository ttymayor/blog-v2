    ...
    <header className="sticky top-0 z-50 w-full pointer-events-none">
      <div
        className={`
          ...
          ${
            isScrolled
              ? "mt-4 w-[95%] max-w-4xl rounded-2xl border border-black/10 shadow-xl bg-white/80 backdrop-blur-md px-6"
              : "w-full bg-white shadow-[0_2px_8px_rgba(var(--black),5%)] px-4"
          }
        `}
      >
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-4">
            <a
              ...
              target="_blank"
              className="flex text-[rgb(var(--black))] hover:text-[rgb(var(--gray-dark))]"
            >
