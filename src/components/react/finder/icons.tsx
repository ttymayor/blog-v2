...
export function FinderIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M8 8.5C8 8.5 9 7 12 7C15 7 16 8.5 16 8.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="9" cy="11" r="1.5" fill="white" />
      <circle cx="15" cy="11" r="1.5" fill="white" />
      <path d="M12 13V16" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M9 17.5C9 17.5 10 19 12 19C14 19 15 17.5 15 17.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function BookIcon() {
  return (
    <svg viewBox="0 0 32 32" className="size-8 shrink-0" fill="none">
      ...
      <line x1="12" y1="10" x2="22" y2="10" stroke="#c9a96e" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="12" y1="14" x2="20" y2="14" stroke="#d4b88c" strokeWidth="1" strokeLinecap="round" />
      <line x1="12" y1="17" x2="18" y2="17" stroke="#d4b88c" strokeWidth="1" strokeLinecap="round" />
    </svg>
  );
}
...
export function SlideIcon() {
  return (
    <svg viewBox="0 0 32 32" className="size-8 shrink-0" fill="none">
      ...
      <line x1="10" y1="11" x2="22" y2="11" stroke="white" strokeWidth="1.5" strokeLinecap="round" opacity="0.8" />
      <line x1="10" y1="14" x2="18" y2="14" stroke="white" strokeWidth="1" strokeLinecap="round" opacity="0.5" />
    </svg>
  );
}
...
export function FolderIcon() {
  return (
    <svg viewBox="0 0 32 32" className="size-8 shrink-0" fill="none">
      <path d="M4 8a2 2 0 012-2h7.172a2 2 0 011.414.586L16 8h10a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V8z" fill="#64b5f6" />
...
export function RuleIcon() {
  return (
    <svg viewBox="0 0 32 32" className="size-8 shrink-0" fill="none">
      ...
      <line x1="10" y1="14.5" x2="22" y2="14.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
      <line x1="10" y1="19" x2="17" y2="19" stroke="white" strokeWidth="1.5" strokeLinecap="round" opacity="0.4" />
    </svg>
  );
}
...
export const sidebarIcons = {
  ...
  chip: (
    <svg viewBox="0 0 16 16" className="size-4 shrink-0" fill="currentColor">
      ...
      <path d="M6 2v2M10 2v2M6 12v2M10 12v2M2 6h2M2 10h2M12 6h2M12 10h2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  ),
  presentation: (
    <svg viewBox="0 0 16 16" className="size-4 shrink-0" fill="currentColor">
  ...
  radar: (
    <svg viewBox="0 0 16 16" className="size-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.2">
